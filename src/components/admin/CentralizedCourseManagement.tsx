...
export const CentralizedCourseManagement: React.FC = () => {
  ...
  const coursesWithStatus = useMemo(() => {
    return courses.map(course => {
      ...
      const modificationRequests = modificationRequests.filter(req => req.course_id === course.id).length;
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            >
              ...
              <SelectContent>
                ...
                {Array.from(new Set(courses.map(c => c.faculty).filter(Boolean))).map(faculty => (
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{course.school || 'Non définie'}</p>
                </div>
                <div>
                        ...
                        <div className="space-y-4">
                          {course.analysis_notes && (
                            <div>
                              ...
                              <p className="text-sm p-2 bg-gray-50 rounded">{course.analysis_notes}</p>
                            </div>
                          )}
                          {course.commission_notes && (
                            <div>
                              <Label className="text-sm font-medium">Notes de commission</Label>
                              <p className="text-sm p-2 bg-gray-50 rounded">{course.commission_notes}</p>
                            </div>
                          )}
                          {!course.analysis_notes && !course.commission_notes && (
